#!/usr/bin/env bash
# Qortex Test Suite - Run All Tests
#
# Usage:
...
# ============================================================
run_test "Ansible Role Validation" "$SCRIPT_DIR/test-qortex-ansible.sh"

# ============================================================
# Test 2: Role Deployment Tests (requires VM)
# ============================================================
if limactl list 2>/dev/null | grep -q "openclaw-sandbox.*Running"; then
  run_test "Role Deployment Tests" "$SCRIPT_DIR/test-qortex-role.sh" "$QUICK_MODE"
else
  echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
