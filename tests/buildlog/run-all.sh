#!/usr/bin/env bash
# Buildlog Test Suite - Run All Tests
#
# Usage:
#   ./tests/buildlog/run-all.sh [--quick]
#
# Options:
#   --quick   Skip VM tests (faster, Ansible validation only)
...
# ============================================================
run_test "Ansible Role Validation" "$SCRIPT_DIR/test-buildlog-ansible.sh"

# ============================================================
# Test 2: Role Deployment Tests (requires VM)
# ============================================================
if limactl list 2>/dev/null | grep -q "openclaw-sandbox.*Running"; then
  run_test "Role Deployment Tests" "$SCRIPT_DIR/test-buildlog-role.sh" "$QUICK_MODE"
else
  echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
  echo -e "${CYAN}Running:${NC} Role Deployment Tests"
  echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
  echo ""
  echo -e "${YELLOW}SKIPPED${NC} (VM not running - run ./bootstrap.sh first)"
  ((TESTS_SKIPPED++))
  echo ""
fi
