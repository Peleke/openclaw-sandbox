#!/usr/bin/env bash
# GitHub CLI Test Suite - Run All Tests
#
# Usage:
...
run_test "Ansible Role Validation" "$SCRIPT_DIR/test-gh-cli-ansible.sh"

# Test 2: VM deployment tests (skip in quick mode)
run_test "VM Deployment Tests" "$SCRIPT_DIR/test-gh-cli-role.sh" "$QUICK_MODE"
