#!/usr/bin/env bash
# Docker + Sandbox Test Suite - Run All Tests
#
# Usage:
...
echo ""
echo "╔═══════════════════════════════════════════════════════════════╗"
echo "║        Docker + Sandbox Test Suite                            ║"
echo "╚═══════════════════════════════════════════════════════════════╝"
echo ""
...
run_test "Ansible Role Validation" "$SCRIPT_DIR/test-sandbox-ansible.sh"

# Test 2: VM deployment tests (skip in quick mode)
run_test "VM Deployment Tests" "$SCRIPT_DIR/test-sandbox-role.sh" "$QUICK_MODE"
