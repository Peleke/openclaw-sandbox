#!/usr/bin/env bash
# Obsidian Vault Sandbox Access Test Suite - Run All Tests
#
# Usage:
...
echo ""
echo "╔═══════════════════════════════════════════════════════════════╗"
echo "║        Obsidian Vault Sandbox Access Test Suite               ║"
echo "╚═══════════════════════════════════════════════════════════════╝"
echo ""
...
# Test 1: Ansible role validation (always runs)
run_test "Ansible Role Validation" "$SCRIPT_DIR/test-obsidian-ansible.sh"

# Test 2: VM deployment tests (skip in quick mode)
run_test "VM Deployment Tests" "$SCRIPT_DIR/test-obsidian-role.sh" "$QUICK_MODE"
