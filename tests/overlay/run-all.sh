#!/usr/bin/env bash
# Overlay Test Suite - Run All Tests
#
# Usage:
...
run_test "Ansible Role Validation" "$SCRIPT_DIR/test-overlay-ansible.sh"

# Test 2: VM deployment tests (skip in quick mode)
run_test "VM Deployment Tests" "$SCRIPT_DIR/test-overlay-role.sh" "$QUICK_MODE"
