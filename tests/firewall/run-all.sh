#!/usr/bin/env bash
# Firewall Test Suite - Run All Tests
#
# Usage:
#   ./tests/firewall/run-all.sh [--quick]
#
# Options:
...
# ============================================================
run_test "Ansible Role Validation" "$SCRIPT_DIR/test-firewall-ansible.sh"
